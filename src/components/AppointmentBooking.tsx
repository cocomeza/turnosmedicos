                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl">
                      ...
                      <div className="space-y-2 text-sm text-gray-700">
                        <p><span className="font-medium">Nombre:</span> {formatName(patientInfo.name)}</p>
                        <p><span className="font-medium">Email:</span> {patientInfo.email.toLowerCase().trim()}</p>
                        {patientInfo.phone && <p><span className="font-medium">Teléfono:</span> {normalizeText(patientInfo.phone)}</p>}
                      </div>
                    </div>
                  </div>
